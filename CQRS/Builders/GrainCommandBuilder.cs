...
public class GrainCommandBuilder<T, C, Q, K> : IGrainCommandBuilder<T, C, Q, K> where T : IGrain
{
    ...
    public IGrainCommandBuilder<T, C, Q, IEnumerable<Output>> ForEachSplit<Input, Output>(IEnumerable<Input> inputs, Func<IGrainCommandBuilder<T, C, Q, Input>, IGrainCommandBuilder<T, C, Q, Output>> operation)
    {
